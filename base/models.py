...
class Product(models.Model):
    ...
    # product_id = models.AutoField(primary_key=True, editable=False, null=False)
    product_id = models.IntegerField(null=True, blank=True)  # Allow null values
...
class Review(models.Model):
    ...
    createdAt = models.DateTimeField(auto_now_add=True)
    #_id = models.IntegerField(null=True, blank=True)  # Allow null values
